...
#define YIN_SAMPLING_RATE 10000
#define YIN_DEFAULT_THRESHOLD 0.15

#define YIN_MAX_BUFFER_SIZE 2048
#define YIN_MAX_HALF_BUFFER_SIZE (YIN_MAX_BUFFER_SIZE / 2)
...
typedef struct _Yin {
	...
	float32_t yinBuffer[YIN_MAX_HALF_BUFFER_SIZE];		/**< Buffer that stores the results of the intermediate processing steps of the algorithm */
